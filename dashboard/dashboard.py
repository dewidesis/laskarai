...
# Impor data
hour_df = pd.read_csv('https://raw.githubusercontent.com/dewidesis/laskarai/refs/heads/main/dashboard/hour_cleaned.csv')
hour_df['dteday'] = pd.to_datetime(hour_df['dteday'])

# Membuat fungsi pengelompokkan berdasarkan musim, bulan, dan hari
def create_season_usage_df(hour_df):
    season_usage_df = hour_df.groupby('season').agg({
        'casual': 'mean',
        'registered': 'mean',
        'cnt': 'mean'
    })
